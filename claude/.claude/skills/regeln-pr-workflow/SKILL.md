...
vor **jedem** PR-Merge offene Reviews prüfen + Threads abarbeiten (umsetzen oder begründet auflösen), erst dann mergen; `BLOCKED` bei grüner CI = unaufgelöste Threads; nach Push ggf. erneut prüfen. Gilt für alle Repos. Volltext:
