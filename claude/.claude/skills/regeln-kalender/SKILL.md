...
Events mit fremden Attendees (ATTENDEE ≠ Tim) sind read-only: nie autonom löschen/verschieben/überschreiben — auch nicht durch Routinen, Tag+7, kohaerenz.py oder Dedup-Heuristik. Bei Konflikt weicht IMMER der Block ohne Attendees, sonst request_approval. Volltext: `~/VAULT_BACKUP/jarvis-wiki-2026-08-26/tim/feedback/kalender-attendee-events-tabu.md` (Archiv)
