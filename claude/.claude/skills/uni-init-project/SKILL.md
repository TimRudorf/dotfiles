...
3. Bei "Browser öffnen":
   ...
   c. User fragen: "Bitte im Browser-Fenster einloggen. Fertig?" → "Ja, eingeloggt" / "Abbrechen"
...
3. **Unbekannte Dateien gruppieren und klassifizieren**: Für alle Dateien die keinem Schlüsselwort entsprechen:
   ...
   d. **Nur bei verbleibender Unsicherheit** (Inhalt nicht eindeutig oder Gruppe zu heterogen) den User fragen, z.B.:
...
2. Den Rename-Plan dem User zur Bestätigung zeigen
