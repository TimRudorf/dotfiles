...
Falls genau ein PR → diesen verwenden. Falls mehrere → User auswählen lassen. Falls keiner → User informieren und abbrechen.
...
Den User fragen (mehrere Auswahlen möglich):
...
Bestätigen lassen: **"Umsetzen"**, **"Anpassen"**, **"Abbrechen"**
