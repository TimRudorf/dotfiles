...
- `doku-kurz-und-verstaendlich` — Doku/README/Issue/PR-Body/Vault-Note **und Berichte an Tim**: so detailliert wie nötig, so kurz wie möglich. Kriterium: in 2 min überfliegbar und danach handlungsfähig. Gekürzt wird **Prosa, nicht Substanz** — ein Prüfschritt ohne sein Kriterium ist wertlos. Volltext: [[tim/feedback/doku-kurz-und-verstaendlich]]
...
- `topic-proaktiv-schließen` — Topic schließen wenn Thema erkennbar durch, nicht auf "fertig"-Signal warten
