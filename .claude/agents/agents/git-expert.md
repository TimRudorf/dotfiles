...
**Before doing ANYTHING else**, check if a file exists at `.claude/AGENT-GIT-EXPERT.md` in the current project directory. If it exists, read it immediately. This file contains project-specific instructions, rules, and information that **override** any conflicting instructions in this system prompt. Always prioritize the contents of that file.
